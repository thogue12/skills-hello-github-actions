...
1. In the **Code** tab of your repository, create a new branch named `welcome-workflow`.
   ...
   <img width="400" alt="create branch screenshot" src="https://github.com/thogue12/skills-hello-github-actions/blob/main/.github/images/create-branch-screenshot.png?raw=true" />
